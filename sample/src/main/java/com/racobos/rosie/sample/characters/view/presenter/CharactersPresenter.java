...
package com.racobos.rosie.sample.characters.view.presenter;
...
import com.racobos.rosie.sample.base.view.presenter.MarvelPresenter;
import com.racobos.rosie.sample.characters.domain.model.Character;
import com.racobos.rosie.sample.characters.domain.usecase.GetCharacters;
import com.racobos.rosie.sample.characters.view.viewmodel.CharacterViewModel;
import com.racobos.rosie.sample.characters.view.viewmodel.mapper.CharacterToCharacterViewModelMapper;
...
public class CharactersPresenter extends MarvelPresenter<CharactersPresenter.View> {
  ...
  @Inject1
  public CharactersPresenter(UseCaseHandler useCaseHandler, GetCharacters getCharacters,
