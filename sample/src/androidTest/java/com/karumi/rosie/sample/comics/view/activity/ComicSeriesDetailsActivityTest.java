...
public class ComicSeriesDetailsActivityTest extends InjectedInstrumentationTest {
  ...
  @Rule
  public IntentsTestRule<ComicSeriesDetailsActivity> activityRule =
  ...
  private void assertRecyclerViewShowComics(List<ComicSeriesDetailViewModel> comics) {
    RecyclerViewInteraction.<ComicSeriesDetailViewModel>onRecyclerView(withId(R.id.rv_comics)).withItems(comics)
            .check(new RecyclerViewInteraction.ItemViewAssertion<ComicSeriesDetailViewModel>() {
              @Override
              public void check(ComicSeriesDetailViewModel comic, View view, NoMatchingViewException e) {
  ...
  @Test
  public void shouldHideLoadingWhenComicSeriesIsLoaded() throws Exception {
